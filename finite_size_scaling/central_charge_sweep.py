...
def parse_args():
    ...
    parser.add_argument("--n_start", type=float, default=1.414, help="Start value of n")
    parser.add_argument("--n_end", type=float, default=1.4145, help="End value of n (exclusive)")
