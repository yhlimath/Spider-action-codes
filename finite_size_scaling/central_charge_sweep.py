...
def parse_args():
    ...
    parser.add_argument("--n_start", type=float, default=1.6178, help="Start value of n")
    parser.add_argument("--n_end", type=float, default=1.6183, help="End value of n (exclusive)")
    parser.add_argument("--n_step", type=float, default=0.0001, help="Step size for n")
