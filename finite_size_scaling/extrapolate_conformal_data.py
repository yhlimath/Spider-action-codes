...
def main():
    ...
    parser.add_argument("-n", "--n_val", type=float, default=1.414213562373095, help="Loop weight n used to calculate exact central charge and v_F")
