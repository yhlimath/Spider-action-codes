...
if __name__ == "__main__":
    ...
    parser.add_argument("-L", type=int, default=18, help="System size L")
    parser.add_argument("-n", "--n_val", type=float, default=1.732, help="Numeric loop weight n (default 1.732)")
